...
std::map<std::string, MHDFloat> IRRBCBackend::automaticParameters(
...
void IRRBCBackend::applyTau(SparseMatrix& mat, const SpectralFieldId& rowId,
...
void IRRBCBackend::stencil(SparseMatrix& mat, const SpectralFieldId& fieldId,
...
void IRRBCBackend::applyGalerkinStencil(SparseMatrix& mat,
   ...
   const NonDimensional::NdMap& nds) const
{
   auto nN = res.counter().dimensions(Dimensions::Space::SPECTRAL, k1r)(0);
