...
#ifndef QUICC_MODEL_BOUSSINESQ_PLANE_RRBC_EXPLICIT_MODELBACKEND_HPP
#define QUICC_MODEL_BOUSSINESQ_PLANE_RRBC_EXPLICIT_MODELBACKEND_HPP
...
namespace Explicit {
    ...
    */
   class ModelBackend: public IRRBCBackend
   {
      public:
         /**
          * @brief Constructor
...
#endif // QUICC_MODEL_BOUSSINESQ_PLANE_RRBC_EXPLICIT_MODELBACKEND_HPP
