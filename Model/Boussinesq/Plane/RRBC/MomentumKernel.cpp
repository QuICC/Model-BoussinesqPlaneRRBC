      ...
      switch(id)
      {
         case(FieldComponents::Physical::X):
            std::visit(
                  [&](auto&& v)
                  {
                     Physical::Cross<FieldComponents::Physical::Y,FieldComponents::Physical::Z>::set(rNLComp, v->dom(0).curl(), v->dom(0).phys(), this->mInertia);
                  }, 
         ...
         case(FieldComponents::Physical::Y):
            std::visit(
                  [&](auto&& v)
                  {
                     Physical::Cross<FieldComponents::Physical::Z,FieldComponents::Physical::X>::set(rNLComp, v->dom(0).curl(), v->dom(0).phys(), this->mInertia);
                  }, 
                  this->vector(this->name()));
            break;
         case(FieldComponents::Physical::Z):
            std::visit(
                  [&](auto&& v)
                  {
                     Physical::Cross<FieldComponents::Physical::X,FieldComponents::Physical::Y>::set(rNLComp, v->dom(0).curl(), v->dom(0).phys(), this->mInertia);
                  }, 
                  this->vector(this->name()));
            break;
         default:
