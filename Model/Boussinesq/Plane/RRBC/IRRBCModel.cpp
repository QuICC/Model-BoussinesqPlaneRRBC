 ...
 * @brief Source of the Boussinesq Rotating Rayleigh-Benard convection in a plane layer (toroidal/poloidal formulation) model
 */
...
namespace RRBC {
   ...
   void IRRBCModel::addEquations(SharedSimulation spSim)
   {
      ...
      spSim->addEquation<Equations::Boussinesq::Plane::RRBC::Transport>(this->spBackend());
                                                           
      // Add Navier-Stokes equation
      spSim->addEquation<Equations::Boussinesq::Plane::RRBC::Momentum>(this->spBackend());
   }
